            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {submitStatus === 'success' && (
                <div className="p-4 bg-green-100 border border-green-400 text-green-700 rounded-lg">
                  ...
                  <p className="text-sm">Your default email client should open with the message ready to send. If it doesn't open automatically, please email me directly at farazcui007@gmail.com</p>
                </div>
              )}
              {submitStatus === 'error' && (
                <div className="p-4 bg-red-100 border border-red-400 text-red-700 rounded-lg">
                  <p className="font-medium">Failed to open email client.</p>
                  <p className="text-sm">Please contact me directly at farazcui007@gmail.com</p>
                </div>
              )}
